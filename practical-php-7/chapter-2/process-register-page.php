	...
	if (empty($errors)) { // if everything is OK
		try {
			...
			if (mysqli_stmt_affected_rows($q) == 1) { // One record inserted
				...
				echo '<footer class="jumbotron text-center col-sm-12" style="padding-bottom:1px; 
					padding-top:8px;"> 
					include("footer.php");
					</footer>';
				exit();
			...
			// print "An Exception ocorred. Message: " . $e->getMessage();
		...
		foreach ($rttotd as $msg) { // Print each error.
			$errorstring .= " - $msg<br>\n";
		}
